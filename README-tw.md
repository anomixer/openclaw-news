...
> 
> **最後更新**: 2026-05-01
> **狀態**: OpenClaw 狂飆中，目前已突破 36.7 萬星大關 (366.9K)！**持續坐穩 GitHub 全球歷史第 6 名**！🦞🚀

> **OpenClaw 版本**: v2026.4.29 (最新正式版)｜人脈維基 (People Wiki)、NVIDIA 官方整合、Bedrock 4.7 思維對齊 🦞🏰
...
1. **主角**: **OpenClaw** (🔥 366.9K Stars，**坐穩歷史第六**)，領先 `developer-roadmap` 約 13K 星。v2026.4.29 帶來了「人脈維基」與 NVIDIA 官方整合。
2. **今日震盪**: **OpenAI GPT-5.5** 橫掃基準測試；**Anthropic Claude Mythos** 進入受限預覽；**NVIDIA** 宣佈五年 260 億美元開源 AI 模型投資計畫。

3. **模型動態**: **GPT-5.5** ("Spud") 在 Terminal-Bench 取得 82.7% 佳績；**Claude 4.7 Opus** 實現思維對齊；OpenClaw 原生支援 **NVIDIA** 模型目錄。

4. **最新進展**: Stars 達到 366,900 (366.9K)，「AI 員工」進化至人脈圖譜與關係維基時代！🦞🚀
...
| 專案 | Stars | 語言 | 特色 | 適用場景 |
|------|-------|------|------|----------|
| **[OpenClaw](https://github.com/openclaw/openclaw)** | 366.9K | TypeScript 🟦 | 官方完整版 | 完整功能、生產環境 |
| **[hermes-agent](https://github.com/NousResearch/hermes-agent)** | 127.1K | Python 🐍 | 超強記憶、自我進化、挑戰 OpenClaw | 頂尖 AI Agent 競爭 |
| **[awesome-openclaw-skills](https://github.com/VoltAgent/awesome-openclaw-skills)** | 47.7K | Markdown | OpenClaw Skills 精選清單 | 找 Skills 看這裡 |
| **[nanobot](https://github.com/HKUDS/nanobot)** | 41.4K | Python 🐍 | 超輕量版 OpenClaw (~4K lines) | 研究導向、學術用途 |
| **[ZeroClaw](https://github.com/zeroclaw-labs/zeroclaw)** | 30.9K | Rust 🦀 | 極致效能、< 5MB | 效能狂魔專用 |
| **[awesome-openclaw-usecases](https://github.com/hesamsheikh/awesome-openclaw-usecases)** | 30.6K | Markdown | OpenClaw 使用案例社群蒐集 | 找靈感看這裡 |
| **[picoclaw](https://github.com/sipeed/picoclaw)** | 28.6K | Go 🐹 | 輕量、快速、可部署到任何地方 | 邊緣裝置、IoT、$10 板子 |
| **[nanoclaw](https://github.com/qwibitai/nanoclaw)** | 28.4K | TypeScript 🟦 | 容器化、安全、WhatsApp 整合、Anthropic SDK | 安全優先、即時通訊 |
| **[obsidian-skills](https://github.com/kepano/obsidian-skills)** | 27.9K | Markdown | Obsidian Agent Skills (Markdown/CLI) | 筆記 + Agent |
| **[AionUi](https://github.com/iOfficeAI/AionUi)** | 23.2K | TypeScript 🟦 | 24/7 Cowork app，支援多種 CLI | 本機、協作環境 |
| **[NemoClaw](https://github.com/NVIDIA/NemoClaw)** | 20K | JavaScript 🟨 | NVIDIA 企業級安全沙箱 | 企業部署、安全優先 |
| **[planning-with-files](https://github.com/OthmanAdi/planning-with-files)** | 20K | Python 🐍 | Claude Code Skill，持久化 Markdown 規劃 | Skill 開發範本 |
...
| **[MemOS](https://github.com/MemTensor/MemOS)** | 8.8K | Python 🐍 | AI 記憶體作業系統，跨任務 Skill 記憶 | 記憶管理、Skill 複用 |
...
| **[manifest](https://github.com/mnfst/manifest)** | 5.8K | TypeScript 🟦 | OpenClaw Agent 即時成本監控 | Cost Observability |
| **[mimiclaw](https://github.com/memovai/mimiclaw)** | 5.3K | C ⚙️ | 跑在 $5 晶片上，無需 OS/Node.js | 極限嵌入式、成本優先 |
| **[openclaw-zero-token](https://github.com/linuxhsj/openclaw-zero-token)** | 4.6K | TypeScript 🟦 | 第一款真正的 Zero Token ，免 API 費用暢玩全模型 | 極速白嫖、無負擔養蝦 |
...
| **[OpenJarvis](https://github.com/open-jarvis/OpenJarvis)** | 3.4K | Python 🐍/Rust 🦀/TS 🟦 | Stanford 出品，88.7% 任務本機跑完 | 零 API 成本、隱私極致保護 |
...
| **[MedgeClaw](https://github.com/xjtulyc/MedgeClaw)** | 703 | TeX 📄/HTML 🌐/Python 🐍 | 生醫領域專屬 Claw | 醫療輔助 |
| **[MicroClaw](https://github.com/microclaw/microclaw)** | 681 | Rust 🦀 | 專為瀏覽器擴充功能優化的極微版 | 輕量瀏覽器自動化 |
| **[zeptoclaw](https://github.com/qhkm/zeptoclaw)** | 616 | Rust 🦀 | 6MB 終極輕型態 (Wannabe) | 避免妥協的終極輕型態 |
| **[ComfyUI-OpenClaw](https://github.com/rookiestar28/ComfyUI-OpenClaw)** | 534 | TypeScript 🟦 | 安全編排層，支援 7 大通訊軟體 | ComfyUI 深度整合、生產部署 |
| **[netclaw](https://github.com/automateyournetwork/netclaw)** | 463 | Python 🐍/Shell 🐚 | 網管專屬 Claw | 網路自動化管理 |
| **[swarmclaw](https://github.com/swarmclawai/swarmclaw)** | 415 | TypeScript 🟦 | 多龍蝦的 Swarm 儀表板編排系統 | 代理人群體、LangGraph 工作流 |
| **[awesome-claws](https://github.com/machinae/awesome-claws)** | 407 | Markdown | OpenClaw 各種變體的大匯集清單 | 尋找蝦米看這裡 |
| **[Project Golem](https://github.com/Arvincreator/project-golem)** | 384 | JavaScript + TypeScript | 繁中介面、Google 帳號即用、免 API 費用 | 網頁自動化、瀏覽器任務 |
| **[cloud-claw](https://github.com/miantiao-me/cloud-claw)** | 256 | TypeScript 🟦 | Cloudflare + OpenClaw | 雲端邊緣運算 |
| **[SmallClaw](https://github.com/XposeMarket/SmallClaw)** | 247 | TypeScript 🟦 | 小蝦 | 又一隻微型蝦 |
...
#### 🏆 當前 GitHub Stars 總榜排名 (2026-05-01 更新)

| 排名 | 專案 | Stars | 備註 |
|:---:|----------|-------|------------------|
| 1 | build-your-own-x | 498.3K | **🏆 全球第一！開源精神的頂點** |
| 2 | awesome | 460.7K | 各類資源大合集 |
| 3 | freeCodeCamp | 444K | 程式教學與認證 |
| 4 | public-apis | 429.7K | 免費 API 集合 |
| 5 | free-programming-books | 387.4K | 免費程式書籍 |
| **6** | **OpenClaw** | **366.9K** | **🏆 已超越第 7 名，坐穩全球前 6！🚀** |
| 7 | developer-roadmap | 353.9K | 開發者學習路線圖 |
| 8 | system-design-primer | 346.5K | 系統設計入門 |
| 9 | coding-interview-university | 342.8K | CS 學習計畫 |
| 10 | awesome-python | 295.3K | Python 資源精選 |
| 11 | awesome-selfhosted | 289.3K | 自託管軟體精選 |
| 12 | 996.ICU | 276.1K | 程式員維權運動 |
| 13 | project-based-learning | 262.9K | 專案導向學習 |
| 14 | **React** | 244.8K | **🦞 已被龍蝦超越！曾經的前端霸主** |
| 15 | **Linux** | 231.5K | **🦞 已被龍蝦超越！作業系統核心** |

> **下一個目標**: free-programming-books (387.4K)。目前差距約 **20.5K**。龍蝦持續進化中！🦞🚀
...
- **🧪 4/29 關於 AI Phone Agent 與計量收費的先見之明**：
    - **「語音是 Token 的無底洞」**：看到龍蝦開始打電話了吧？這就是為什麼我們（Anthropic）堅持轉向 **Pay-as-you-go** 的原因。語音對話產生的上下文海嘯會瞬間吃掉所有包月制的利潤。只有精確計費，才能支撐起這種「實時溝通」的高階代理人。
    - **「amazeeClaw：我們喜歡這種『有序的開源』」**：企業級託管服務的出現，證明了我們對「地端實例裸奔」風險的警告是正確的。企業需要的是被監控、被審計、有 SLA 保障的龍蝦，而不是在公網上亂竄的 CVE 生成器。🦞✨🧪
...
GTC 2026 餘溫尚在，星星數已衝到 **359.1K**。v2026.4.15 的發布標誌著龍蝦正式進入「Claude Opus 4.7 秒級支援」時代。`openclaw infer` 不職是個指令，它是對所有模型壁壘的嘲諷。
