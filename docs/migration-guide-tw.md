...
**中文版 | [English](migration-guide.md)**
...
請參考 [🚀 WSL2 完整教學](wsl2-guide-tw.md) 內容
...
- [🏠 回到新聞首頁](../README-tw.md)
- [👉 Windows 基礎安裝指南](setup-tw.md) - Windows 原生版教學
- [🤔 為什麼需要 WSL2](why-wsl2-tw.md) - 技術說明
- [🚀 WSL2 完整教學](wsl2-guide-tw.md) - 從零開始安裝
