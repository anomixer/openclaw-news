...
- 若需要**完整功能**（memory、skills）→ 請改用 [🚀 WSL2 完整教學](wsl2-guide-tw.md)
- 已安裝 Windows 版但遇到問題 → 參考 [🔄 遷移指南](migration-guide-tw.md)

📚 **更多資訊**：[🤔 為什麼需要 WSL2](why-wsl2-tw.md)
...
> 💡 **提示**: 雲端模型有用量限制，不要過於頻繁使用。詳見 [🧠 模型選用指南](what-model-tw.md)。
