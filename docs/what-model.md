# 🧠 Deployment Guide: Which Model to Pick? (Model Landscape)

**[中文版](what-model-tw.md) | English**
...
2. **⚠️ Security Warning**: If you're using cloud models, guard your **API Keys** with your life! The recent $82,000 hijacking incident is a brutal wake-up call (see [Latest Crisis](setup.md#-2026-03-12-300k-stars-achieved-nvidias-growth-pill--the-api-hijacking-crisis-🚀🦞)); always set strict usage quotas.
...
- [🏠 Back to Home / Battlefield Log (README.md)](../README.md)
