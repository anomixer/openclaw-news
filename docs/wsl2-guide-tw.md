...
**中文版 | [English](wsl2-guide.md)**

**[🏠 回到戰況日誌](../README-tw.md) | [👉 Windows 基礎安裝指南](setup-tw.md) | [🚀 WSL2 完整教學](wsl2-guide-tw.md) | [🤔 為什麼需要 WSL2](why-wsl2-tw.md) | [🔄 遷移指南](migration-guide-tw.md) | [🧠 模型選用指南](what-model-tw.md)**

> 這是從零開始在 WSL2 安裝 OpenClaw + Ollama 的完整指南。

> 若您的作業系統是 Ubuntu / macOS ，可以直接從第2步驟開始。

> 如果你已經在 Windows 原生環境安裝過，請優先看：**[🔄 遷移指南](migration-guide-tw.md)**。
...
**選項 A：Qwen 3.6 27B（推薦，18GB+ VRAM）**

```bash
ollama pull qwen3.6-27b
```

**選項 B：Ornith 9B（輕量，10GB+ VRAM）**
...
# 儲存新模型，可輸入原先模型名稱 (qwen3.6-27b:latest) 直接更新
>>> /save <model name>
...
- [🏠 回到新聞首頁](../README-tw.md)
- [👉 Windows 基礎安裝指南](setup-tw.md)
- [🔄 遷移指南](migration-guide-tw.md)
- [🤔 為什麼需要 WSL2](why-wsl2-tw.md)
- [🧠 模型選用指南](what-model-tw.md)
...
遇到問題？歡迎在 [GitHub Issues](https://github.com/anomixer/openclaw-news/issues) 提出！
...
### 2026-01-30
- 🦞 Repo 重新命名為 openclaw-news
- 🌍 新增英文版 README
- 💬 新增 murmur-tw.md 吐槽檔案
...
- [👉 Windows 基礎安裝指南](setup-tw.md) - Windows 原生教學
- [🤔 為什麼需要 WSL2](why-wsl2-tw.md) - 技術背景
- [🔄 遷移指南](migration-guide-tw.md)
