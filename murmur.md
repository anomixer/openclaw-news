...
> 
> **最後更新**: 2026-04-15
> **狀態**: OpenClaw 狂飆中，目前已突破 35.7 萬星大關 (357.4K)！**持續坐穩 GitHub 全球歷史第 6 名**！🦞🚀

> **OpenClaw 版本**: v2026.4.14 (最新版)｜GPT-5.4 Pro 支援、Telegram 論壇主題、性能優化 🦞🏰

---

## ⏱️ TL;DR (30秒快速懶人包)

1. **主角**: **OpenClaw** (🔥 357.4K Stars，**坐穩歷史第六**)，領先 `developer-roadmap` 約 4.5K 星。v2026.4.14 新增 GPT-5.4 Pro 前向相容支援與 Telegram 論壇主題功能。
2. **今日震盪**: **v2026.4.14 發佈**；AI 企業限額供應時代來臨；PwC 台灣發布企業 AI 調查報告；OpenAI 千億融資傳聞持續發酵；Google I/O 2026 預告。
3. **模型動態**: **Claude 4.5 Opus** 橫掃 VLM 基準測試；OpenAI 估值衝向 8400 億美元；Nvidia 擴大 CoreWeave 算力供應。
4. **最新進展**: Stars 衝上 35.7 萬 (357.4K)，距離全球第 5 名僅剩 28.1K 星！
...
- **🚀 變體競爭：hermes-agent 持續施壓**：NousResearch 的 hermes-agent (84.5K Stars) 持續吸引 OpenClaw 用戶，其「自我進化技能包」與 SQLite/FTS5 持久化記憶架構被視為更先進的代理人智慧解決方案。
...
- **🚀 變體競爭：hermes-agent v0.9.0 震撼發布**：作為 OpenClaw 的頭號競爭對手，NousResearch 於昨日發布 v0.9.0。新增 **Local Web Dashboard**、支援 Android/Termux 原生執行，並透過 iLink Bot API 實現了 **WeChat/WeCom 原生整合**。其主打的「自我進化技能包 (Self-improving Skills)」與 SQLite/FTS5 持久化記憶架構正吸引大量 OpenClaw 用戶轉投，被社群視為「更具備代理人智慧」的架構挑戰者。
...
| 專案 | Stars | 語言 | 特色 | 適用場景 |
|------|-------|------|------|----------|
| **[OpenClaw](https://github.com/openclaw/openclaw)** | 357.4K | TypeScript 🟦 | 官方完整版 | 完整功能、生產環境 |
| **[hermes-agent](https://github.com/NousResearch/hermes-agent)** | 84.5K | TypeScript 🟦 | 超強記憶、自我進化、挑戰 OpenClaw | 頂尖 AI Agent 競爭 |
| **[awesome-openclaw-skills](https://github.com/VoltAgent/awesome-openclaw-skills)** | 46K | Markdown | OpenClaw Skills 精選清單 | 找 Skills 看這裡 |
| **[nanobot](https://github.com/HKUDS/nanobot)** | 39.5K | Python 🐍 | 超輕量版 OpenClaw (~4K lines) | 研究導向、學術用途 |
| **[ZeroClaw](https://github.com/zeroclaw-labs/zeroclaw)** | 30.1K | Rust 🦀 | 極致效能、< 5MB | 效能狂魔專用 |
...
| **[obsidian-skills](https://github.com/kepano/obsidian-skills)** | 24K | Markdown | Obsidian Agent Skills (Markdown/CLI) | 筆記 + Agent |
| **[AionUi](https://github.com/iOfficeAI/AionUi)** | 21.8K | TypeScript 🟦 | 24/7 Cowork app，支援多種 CLI | 本機、協作環境 |
| **[NemoClaw](https://github.com/NVIDIA/NemoClaw)** | 19.2K | JavaScript 🟨 | NVIDIA 企業級安全沙箱 | 企業部署、安全優先 |
| **[planning-with-files](https://github.com/OthmanAdi/planning-with-files)** | 18.7K | Python 🐍 | Claude Code Skill，持久化 Markdown 規劃 | Skill 開發範本 |
...
| **[openclaw-zero-token](https://github.com/linuxhsj/openclaw-zero-token)** | 4.2K | TypeScript 🟦 | 第一款真正的 Zero Token ，免 API 費用暢玩全模型 | 極速白嫖、無負擔養蝦 |
...
| **[OpenJarvis](https://github.com/open-jarvis/OpenJarvis)** | 2.6K | Python 🐍/Rust 🦀/TS 🟦 | Stanford 出品，88.7% 任務本機跑完 | 零 API 成本、隱私極致保護 |
...
| **[MicroClaw](https://github.com/microclaw/microclaw)** | 649 | Rust 🦀 | 專為瀏覽器擴充功能優化的極微版 | 輕量瀏覽器自動化 |
| **[zeptoclaw](https://github.com/qhkm/zeptoclaw)** | 589 | Rust 🦀 | 6MB 終極輕型態 (Wannabe) | 避免妥協的終極輕型態 |
| **[ComfyUI-OpenClaw](https://github.com/rookiestar28/ComfyUI-OpenClaw)** | 521 | TypeScript 🟦 | 安全編排層，支援 7 大通訊軟體 | ComfyUI 深度整合、生產部署 |
| **[netclaw](https://github.com/automateyournetwork/netclaw)** | 413 | Python 🐍/Shell 🐚 | 網管專屬 Claw | 網路自動化管理 |
| **[awesome-claws](https://github.com/machinae/awesome-claws)** | 399 | Markdown | OpenClaw 各種變體的大匯集清單 | 尋找蝦米看這裡 |
| **[Project Golem](https://github.com/Arvincreator/project-golem)** | 348 | JavaScript + TypeScript | 繁中介面、Google 帳號即用、免 API 費用 | 網頁自動化、瀏覽器任務 |
| **[swarmclaw](https://github.com/swarmclawai/swarmclaw)** | 341 | TypeScript 🟦 | 多龍蝦的 Swarm 儀表板編排系統 | 代理人群體、LangGraph 工作流 |
...
#### 🏆 當前 GitHub Stars 總榜排名 (2026-04-15 更新)

| 排名 | 專案 | Stars | 備註 |
|:---:|----------|-------|------------------|
| 1 | build-your-own-x | 490.4K | 各種實作大成 |
| 2 | awesome | 455.3K | 資源大本營 |
| 3 | freeCodeCamp | 442.9K | 教程大本營 |
| 4 | public-apis | 421.9K | 免費 API 集合 |
| 5 | free-programming-books | 385.5K | 程式書籍匯集 |
| **6** | **OpenClaw** | **357.4K** | **🏆 已超越第 7 名！挺進全球前六！** |
| 7 | developer-roadmap | 352.9K | 開發者路徑圖 |
| 8 | system-design-primer | 342.8K | 系統設計入門 |
| 9 | coding-interview-university | 340.8K | CS 面試準備指南 |
| 10 | awesome-python | 292.3K | Python 資源精選 |
| 11 | awesome-selfhosted | 286K | 自託管軟體精選 |
| 12 | 996.ICU | 275.9K | 工作權益抗議項目 |
| 13 | project-based-learning | 262.9K | 專案導向學習 |
| 14 | **React** | 244.5K | **🦞 已被 OpenClaw 超越！前前端霸主** |
| 15 | **Linux** | 228.9K | **🦞 已被 OpenClaw 超越！系統核心** |

> **下一個目標**: free-programming-books (385.5K)。目前差距約 **28.9K**。龍蝦持續進化中！🦞🚀
...
*   **給 hermes-agent 的一句話：** NousResearch 的 **v0.9.0** 確實很有衝勁，什麼自我進化技能、微信整合，聽起來像是在學我們去年的實驗室草案。但在真正的通用智慧（AGI）面前，這不過是另一隻長得大一點的「蝦子」。在 OpenAI 的 Agent Store，我們會讓你看看什麼叫「標準」。
