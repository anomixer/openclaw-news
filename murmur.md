...
> 
> **最後更新**: 2026-04-09
> **狀態**: OpenClaw 存活中，目前已衝上 35.2 萬星大關 (352.4K)！穩坐 GitHub #7，距離 #6 僅剩 100 星！🦞🚀

> **OpenClaw 版本**: v2026.4.8 (最新穩定版)｜Memory/Dreaming 強化、Diary View 日記視圖、SSRF/Env 安全硬化 🦞🎬

---

## ⏱️ TL;DR (30秒快速懶人包)

1. **主角**: **OpenClaw** (🔥 352.4K Stars，**穩坐歷史第七**)，與第 6 名差距縮至 **0.1K (100星)**。v2026.4.8 帶來了全新的 `Diary View` 聯絡日記。
2. **今日震盪**: **v2026.4.8 穩定版發布**；**Meta 發表 Muse Spark 個性化超智能模型**；**Anthropic 推出 Managed Agents 進入公測**；**Project Glasswing 資安計畫啟動**。
3. **模型動態**: **Meta 轉向閉源**；Muse Spark 具備「冥想模式」；Managed Agents 特化「Agent Harness」框架；OpenClaw 保持協議相容。
4. **最新進展**: Stars 衝上 35.2 萬 (352.4K)，距離全球第 6 名 `developer-roadmap` (352.5K) 僅剩 100 星！
5. **背景**: 2026 年代理人 AI 市場預估突破 110 億美元，高達 40% 的企業應用將整合任務型代理人。
6. **結論**: 面對官方「全家桶」與閉源超大模型（Muse Spark）的收編壓力，OpenClaw 憑藉更強的地端隱私與靈活的插件生態保持領先。🦞🛡️
...
| 專案 | Stars | 語言 | 特色 | 適用場景 |
|------|-------|------|------|----------|
| **[OpenClaw](https://github.com/openclaw/openclaw)** | 352.4K | TypeScript 🟦 | 官方完整版 | 完整功能、生產環境 |
| **[awesome-openclaw-skills](https://github.com/VoltAgent/awesome-openclaw-skills)** | 45.1K | Markdown | OpenClaw Skills 精選清單 | 找 Skills 看這裡 |
| **[nanobot](https://github.com/HKUDS/nanobot)** | 38.6K | Python 🐍 | 超輕量版 OpenClaw (~4K lines) | 研究導向、學術用途 |
| **[ZeroClaw](https://github.com/zeroclaw-labs/zeroclaw)** | 29.8K | Rust 🦀 | 極致效能、< 5MB | 效能狂魔專用 |
| **[awesome-openclaw-usecases](https://github.com/hesamsheikh/awesome-openclaw-usecases)** | 29K | Markdown | OpenClaw 使用案例社群蒐集 | 找靈感看這裡 |
| **[picoclaw](https://github.com/sipeed/picoclaw)** | 27.9K | Go 🐹 | 輕量、快速、可部署到任何地方 | 邊緣裝置、IoT、$10 板子 |
| **[nanoclaw](https://github.com/qwibitai/nanoclaw)** | 26.9K | TypeScript 🟦 | 容器化、安全、WhatsApp 整合、Anthropic SDK | 安全優先、即時通訊 |
| **[obsidian-skills](https://github.com/kepano/obsidian-skills)** | 21.8K | Markdown | Obsidian Agent Skills (Markdown/CLI) | 筆記 + Agent |
| **[AionUi](https://github.com/iOfficeAI/AionUi)** | 21.3K | TypeScript 🟦 | 24/7 Cowork app，支援多種 CLI | 本機、協作環境 |
| **[NemoClaw](https://github.com/NVIDIA/NemoClaw)** | 18.8K | JavaScript 🟨 | NVIDIA 企業級安全沙箱 | 企業部署、安全優先 |
| **[planning-with-files](https://github.com/OthmanAdi/planning-with-files)** | 18.3K | Python 🐍 | Claude Code Skill，持久化 Markdown 規劃 | Skill 開發範本 |
| **[memU](https://github.com/NevaMind-AI/memU)** | 13.3K | Python 🐍 | 24/7 主動式 Agent 的記憶系統 | 長期記憶、主動式 AI |
| **[ironclaw](https://github.com/nearai/ironclaw)** | 11.6K | Rust 🦀 | 注重隱私與安全的 Rust 實作 | 安全敏感場景 |
...
| **[OpenJarvis](https://github.com/open-jarvis/OpenJarvis)** | 2.4K | Python 🐍/Rust 🦀/TS 🟦 | Stanford 出品，88.7% 任務本機跑完 | 零 API 成本、隱私極致保護 |
| **[VisionClaw](https://github.com/sseanliu/VisionClaw)** | 1.5K | Swift 🍎/Kotlin 🟣/JS 🟨 | 智慧眼鏡 Claw | 穿戴式代理人 |
| **[MedgeClaw](https://github.com/xjtulyc/MedgeClaw)** | 957 | TeX 📄/HTML 🌐/Python 🐍 | 生醫領域專屬 Claw | 醫療輔助 |
| **[MicroClaw](https://github.com/microclaw/microclaw)** | 637 | Rust 🦀 | 專為瀏覽器擴充功能優化的極微版 | 輕量瀏覽器自動化 |
| **[zeptoclaw](https://github.com/qhkm/zeptoclaw)** | 585 | Rust 🦀 | 6MB 終極輕型態 (Wannabe) | 避免妥協的終極輕型態 |
| **[ComfyUI-OpenClaw](https://github.com/rookiestar28/ComfyUI-OpenClaw)** | 516 | TypeScript 🟦 | 安全編排層，支援 7 大通訊軟體 | ComfyUI 深度整合、生產部署 |
| **[netclaw](https://github.com/automateyournetwork/netclaw)** | 404 | Python 🐍/Shell 🐚 | 網管專屬 Claw | 網路自動化管理 |
| **[awesome-claws](https://github.com/machinae/awesome-claws)** | 393 | Markdown | OpenClaw 各種變體的大匯集清單 | 尋找蝦米看這裡 |
| **[Project Golem](https://github.com/Arvincreator/project-golem)** | 339 | JavaScript + TypeScript | 繁中介面、Google 帳號即用、免 API 費用 | 網頁自動化、瀏覽器任務 |
| **[swarmclaw](https://github.com/swarmclawai/swarmclaw)** | 288 | TypeScript 🟦 | 多龍蝦的 Swarm 儀表板編排系統 | 代理人群體、LangGraph 工作流 |
| **[cloud-claw](https://github.com/miantiao-me/cloud-claw)** | 252 | TypeScript 🟦 | Cloudflare + OpenClaw | 雲端邊緣運算 |
| **[SmallClaw](https://github.com/XposeMarket/SmallClaw)** | 231 | TypeScript 🟦 | 小蝦 | 又一隻微型蝦 |
| **[MaxClaw](https://github.com/Lichas/maxclaw)** | 205 | Go 🐹/TS 🟦 | 小蝦 (與廠商 MiniMax 撞名) | 輕量 Agent |
| **[lightclaw](https://github.com/zofrasca/lightclaw)** | 205 | Rust 🦀/Shell 🐚 | 輕盈蝦 | 輕量解決方案 |
| **[MiniClawd](https://github.com/FoundDream/miniclawd)** | 120 | Python 🐍 | 零依賴、純 Python 實作 | 腳本集成、快速原型 |
...
| **2026/04/08** | **351.3K** | 即時抓取更新 | 🦞 |
| **2026/04/09** | **352.4K** | 即時抓取更新 | 🦞 |

#### 🏆 當前 GitHub Stars 總榜排名 (2026-04-09 更新)

| 排名 | 專案 | Stars | 備註 |
|:---:|----------|-------|------------------|
| 1 | build-your-own-x | 487.7K | 各種實作大成 |
| 2 | awesome | 453.3K | 資源大本營 |
| 3 | freeCodeCamp | 442.2K | 教程大本營 |
| 4 | public-apis | 420.3K | 免費 API 集合 |
| 5 | free-programming-books | 385.2K | 程式書籍匯集 |
| 6 | developer-roadmap | 352.5K | 開發者路徑圖 |
| **7** | **OpenClaw** | **352.4K** | **🏆 與第 6 名僅差 100 星！** |
| 8 | system-design-primer | 341.9K | 系統設計入門 |
| 9 | coding-interview-university | 300.5K | CS 面試準備指南 |
| 10 | **React** | 244.5K | **🦞 已被 OpenClaw 超越！前前端霸主** |
| 11 | vue | 209.9K | 前端框架 |
| 12 | **Linux** | 227.6K | **🦞 已被 OpenClaw 超越！系統核心** |
| 13 | Python | 219.4K | 演算法集合 |
| 14 | tensorflow | 185K | 機器學習框架 |
| 15 | ohmyzsh | 178K | Zsh 配置框架 |

> **下一個目標**: developer-roadmap (352.5K)。目前差距僅 **0.1K (100星)**。以目前日增 ~1K-2K 的速度，預計在 **2 小時內** 完成超越，挺進歷史前六！🦞🚀
...
**🏆 GTC 2026、35 萬星、與「推理大一統」的新秩序：**
GTC 2026 餘溫尚在，星星數已衝到 **352.4K**。v2026.4.8 的發布標誌著龍蝦正式進入「穩定與硬化」時代。`openclaw infer` 不只是個指令，它是對所有模型壁壘的嘲諷。
